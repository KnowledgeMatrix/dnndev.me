				...
				<header class="eds_header">
					<div class="eds_userLanguageBg clearfix">
						<div class="center-block container-fluid">
							<div class="pull-left eds_topHeaderIcons" id="topheadericons" runat="server" ></div>
							<div class="header2search pull-right" style="margin-top:2px;padding-left: 30px;">
					...
					<div class="center-block container-fluid clearfix">
						<div class="eds_headerRight pull-right eds_headerBanner eds_bannerPane" id="bannerpane" runat="server"></div>
