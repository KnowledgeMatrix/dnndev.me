...
<div class="<StyleWizard:Container runat="server" id="OzoneContainer" templateGroup="colorBox" /> eds_containerBox">
	<h2 class="eds_bottomBorder"><dnn:TITLE runat="server" id="dnnTITLE" CssClass="eds_containerTitle" /></h2>
	<div id="ContentPane" runat="server" CssClass="eds_containerTitle"></div>
