...
<!-- header_StyleWizardTemplateSectionEnd -->
	...
	<div id="contentPane3" class="eds_contentBellow2 container-fluid eds_container" runat="server" >
	...
	<div class="edsCopyrightBg">
        <div class="container-fluid">
			<div class="row">
				<div id="Div3" class="col-sm-2 footerBoxContainer2" runat="server"></div>
				<div id="Div4" class="col-sm-2 footerBoxContainer2" runat="server"></div>
				<div id="Div5" class="col-sm-2 footerBoxContainer2" runat="server"></div>
				<div id="Div6" class="col-sm-2 footerBoxContainer2" runat="server"></div>
				<div id="Div7" class="col-sm-2 footerBoxContainer2" runat="server"></div>
				<div id="Div8" class="col-sm-2 footerBoxContainer2" runat="server"></div>
			</div>
		</div>
		...
		<div class="edsCopyright container-fluid clearfix"></div>
	</div>
</div>
