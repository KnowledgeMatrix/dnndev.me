        ...
        <div class="eds_fixedHeader eds_headerHeight" data-placeholder-selector=".eds_headerHeightHolder">
            <div class="eds_headerBackground">
                <header class="eds_header clearfix center-block container-fluid">
                    <div class="eds_logo pull-left eds_logoHeader1">
...
<!-- header_StyleWizardTemplateSectionEnd -->
  ...
  <!-- display list items in the header-->
    ...
    <div>
        <div class="col-sm-4 eds_container" id="placeholdersPane1" runat="server"></div>
        <div class="col-sm-4 eds_container" id="placeholdersPane2" runat="server"></div>
        <div class="col-sm-4 eds_container" id="placeholdersPane3" runat="server"></div>
    </div>
 
    <div class="row catlog_section">
          <div class="col-sm-12"><h4 style="color:black" class=".col-sm-2.eds_container"><p>Featured Items</p></h4>  </div>
    ...
    <div class="row">
        <div class="catlog_section" id="make_model_year">
            <div class="col-sm-2 eds_container edess_container">
                <h4><p>Find Parts For Your Ride</p></h4>
            </div>
            <div class="col-sm-10">
                <div class="row">
                    <div class="col-sm-3 eds_container" id="PartsPane" runat="server"></div>
                    <div class="col-sm-3 eds_container" id="PartsPane1" runat="server"></div>
                    <div class="col-sm-3 eds_container" id="PartsPane2" runat="server"></div>
                     <div class="col-sm-3 eds_container edess_container">
                        <h4 style="text-align:center"><p>Go<br />Reset</p>
                        </h4>
                    </div>
                  </div>
            </div>
