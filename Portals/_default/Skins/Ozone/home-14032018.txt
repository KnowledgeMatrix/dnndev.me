...
<a href="https://www.facebook.com/Shelby-American-117534441604489/" target="_Blank"><i class="fab fa-facebook-square"></i></a>
<a href="https://twitter.com/shelbyamerican" target="_Blank"><i class="fab fa-twitter-square"></i></a>
<a href="https://www.youtube.com/channel/UCFw5ji3WjhqiRQHGnVmqCzw" target="_Blank"><i class="fab fa-youtube-square"></i></a>
<a href="http://www.linkedin.com/pub/shelby-american-sales/30/365/446" target="_Blank"><i class="fab fa-linkedin"></i></a>
</div>		
					<% End If %>
...
<!-- header_StyleWizardTemplateSectionEnd -->
	...
	<div id="ContentPane" class="eds_container container-fluid" runat="server">
<div class="calEventsDiv"> <a style="color:#fff;" class="btn btn-danger center-block"  href=""> EVENTS CALENDERS
       </a></div>
</div>
	...
	<div class="container-fluid">
		<div class="">
			...
			<div id="contentRightPane" class="col-sm-1 eds_container" runat="server"></div>--%>
		</div>
	</div>
	<div class="eds_contentBellowBackground">
		...
		<div class="container-fluid">
			...
			<div class="row">			
				<div id="threeColumnLeftPane2" class="col-sm-3 eds_container padding-none" runat="server"></div>
				<div id="threeColumnMiddlePane2" class="col-sm-3 eds_container padding-none" runat="server"></div>
				<div id="threeColumnRightPane2" class="col-sm-3 eds_container padding-none" runat="server"></div>
				<div id="div1" class="col-sm-3 eds_container" runat="server"></div>
			</div>
		</div>
	</div>
	<div id="contentPane3" class="eds_contentBellow2 container-fluid eds_container" runat="server" style="background-image: url(/portals/0/images/BGImage.jpg);    background-size: contain !important;
  ...
  width: 100%; border: 1px solid black;">
	...
	<div id="contentPane8"  class="container-fluid new_bg" runat="server"></div>
	<div class="container-fluid">
		<div class="row">
	...
	<div class="container-fluid eds_container new_bg" id="BottomPane1" runat="server"></div>
