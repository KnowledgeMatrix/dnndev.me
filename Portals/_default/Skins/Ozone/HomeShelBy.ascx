...
<!-- header_StyleWizardTemplateSectionEnd -->
	...
	<div class="container-fluid">
		<div class="row">
			<div id="contentLeftPane" class="col-sm-12 eds_container" runat="server"></div>
             <div> <a style="color:#fff;" class="btn btn-danger center-block calevent"  href="http://123.176.39.60/CALENDAR"> EVENTS CALENDERS
       </a></div>
	...
	<div id="contentPane3" class="eds_contentBellow2 container-fluid eds_container"   style="background-image: url(/portals/0/images/bg-car.jpg);  width: 100%; border: 1px solid black;" runat="server">
