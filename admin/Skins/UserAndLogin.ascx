...
<div class="userProperties">
    <ul>
        ...
        <%  }
            ...
            {
        %>
                <li class="userName"><a id="dnn_dnnUser_userNameLink" href="javascript:void(0)"><%=DisplayName %></a>
                    <ul class="userMenu">
                        <li class="viewProfile"><asp:HyperLink ID="viewProfileLink" runat="server"><%=LocalizeString("Profile")%></asp:HyperLink></li>
                        <li class="userMessages"><asp:HyperLink ID="messagesLink" runat="server"><asp:Label ID="messageCount" runat="server" Visible="true" /> <%=LocalizeString("Messages") %></asp:HyperLink></li>
                        <li class="userNotifications"><asp:HyperLink ID="notificationsLink" runat="server"><asp:Label ID="notificationCount" runat="server" Visible="true"/> <%=LocalizeString("Notifications") %></asp:HyperLink></li>
