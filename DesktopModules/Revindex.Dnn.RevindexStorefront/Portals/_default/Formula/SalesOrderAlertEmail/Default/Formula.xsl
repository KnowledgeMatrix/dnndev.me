<xsl:transform version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    <out>
      ...
      <subject>
        <xsl:value-of select="in/configuration/generalStoreName" /> Order Alert [<xsl:value-of select="in/user/username" /> - Order #<xsl:value-of select="in/salesOrder/salesOrderNumber" />]
      </subject>
      <textBody xml:space="preserve">
========================================================================
<xsl:value-of select="in/configuration/generalStoreName" /> Order Alert
========================================================================
...
Bill To:
<xsl:value-of select="concat(in/salesOrder/billingFirstName, ' ', in/salesOrder/billingLastName)" /> <xsl:value-of select="in/salesOrder/billingCompany" />
...
Points earned: <xsl:value-of select="in/salesOrder/rewardsPointsQualified" />
      ...
      <htmlBody xml:space="preserve">
		<table width="100%" border="0" cellspacing="0" cellpadding="3" style="background-color:#EEEEEE">
			<tr>
				<td style="font-size:large"><xsl:value-of select="in/configuration/generalStoreName" /> Order Alert</td>
			</tr>
		</table>
		<br />
