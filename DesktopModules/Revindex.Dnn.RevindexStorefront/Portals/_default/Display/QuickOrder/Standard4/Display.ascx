<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Display.ascx.cs" Inherits="Revindex.Dnn.RevindexStorefront.Portals._default.Display.QuickOrder.Standard4.Display" %>
		...
		<ContentTemplate>
			...
			<asp:Panel ID="SearchPanel" runat="server" CssClass="dnnForm" DefaultButton="AddToCartLinkButton">
				...
				<ul class="dnnActions dnnClear">
					...
					<li>
						<asp:LinkButton ID="AddToQuoteLinkButton" runat="server" CssClass="dnnPrimaryAction rvdsfAddToQuoteAction" resourcekey="AddToQuoteLinkButton" ValidationGroup="QuickOrderSearchControl" OnClick="AddToQuoteLinkButton_Click" /></li>
					<li>
