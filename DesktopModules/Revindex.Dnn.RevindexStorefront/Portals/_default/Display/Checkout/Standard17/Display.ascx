<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Display.ascx.cs" Inherits="Revindex.Dnn.RevindexStorefront.Portals._default.Display.Checkout.Standard17.Display" %>
...
<div class="rvdsfCheckoutContainer">
			...
			<ContentTemplate>
				...
				<asp:Panel ID="ShippingSectionPanel" runat="server">
					...
					<fieldset>
						...
						<asp:Panel ID="ShippingMethodPanel" runat="server" CssClass="dnnFormItem">
							<dnn1:LabelControl ID="ShippingMethodLabelControl" runat="server" CssClass="dnnFormRequired" />
							<asp:DropDownList ID="ShippingMethodDropDownList" runat="server" CssClass="dnnFormRequired">
							</asp:DropDownList>
						</asp:Panel>
					</fieldset>
				</asp:Panel>
				<asp:Panel ID="OtherInformationPanel" runat="server">
					...
					<fieldset>
						<asp:Panel ID="CouponPanel" runat="server" CssClass="dnnFormItem">
							...
							<asp:LinkButton ID="AddCouponLinkButton" runat="server" OnClick="AddCouponLinkButton_Click" ValidationGroup="CheckoutDisplayTemplate" CssClass="rvdAddNewGridAction" />
	...
	<asp:Panel ID="PlaceOrderPanel" runat="server" CssClass="dnnForm">
		<h2 class="dnnFormSectionHead">
		...
		<asp:UpdatePanel ID="UpdatePanel2" runat="server">
			<ContentTemplate>
				...
				<div class="rvdsfCheckoutPaymentContainer">
					...
					<asp:Panel ID="PaymentMethodsPanel" runat="server">
						<asp:Panel ID="RewardsPointPanel" runat="server">
							...
							<div class="dnnFormItem">
								...
								<asp:LinkButton ID="AddRewardsPointLinkButton" runat="server" OnClick="AddRewardsPointLinkButton_Click" ValidationGroup="CheckoutDisplayTemplate" CausesValidation="False" CssClass="rvdAddNewGridAction" />
						...
						<asp:Panel ID="VoucherPanel" runat="server">
							<div class="dnnFormItem">
								...
								<asp:LinkButton ID="AddVoucherLinkButton" runat="server" OnClick="AddVoucherLinkButton_Click" ValidationGroup="CheckoutDisplayTemplate" CausesValidation="False" CssClass="rvdAddNewGridAction" />
