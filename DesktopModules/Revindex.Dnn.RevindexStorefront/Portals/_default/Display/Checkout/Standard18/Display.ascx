<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Display.ascx.cs" Inherits="Revindex.Dnn.RevindexStorefront.Portals._default.Display.Checkout.Standard18.Display" %>
                    ...
                    <asp:Panel ID="ShippingSectionPanel" runat="server">
                        ...
                        <fieldset>
                            ...
                            <asp:Panel ID="ShippingMethodPanel" runat="server" CssClass="dnnFormItem">
                                ...
                                <asp:DropDownList ID="ShippingMethodDropDownList" runat="server" CssClass="dnnFormRequired" AutoPostBack="True">
                                </asp:DropDownList>
                            </asp:Panel>
                        </fieldset>
                    </asp:Panel>
                    <asp:Panel ID="OtherInformationPanel" runat="server">
                        ...
                        <fieldset>
                            <asp:Panel ID="CouponPanel" runat="server" CssClass="dnnFormItem">
                                ...
                                <asp:LinkButton ID="AddCouponLinkButton" runat="server" OnClick="AddCouponLinkButton_Click" ValidationGroup="CheckoutDisplayTemplate" CssClass="rvdAddNewGridAction" CausesValidation="False" />
