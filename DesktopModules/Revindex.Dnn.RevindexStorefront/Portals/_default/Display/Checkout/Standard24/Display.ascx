<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Display.ascx.cs" Inherits="Revindex.Dnn.RevindexStorefront.Portals._default.Display.Checkout.Standard24.Display" %>
		...
		<ContentTemplate>
			...
			<asp:Panel ID="BillingAndShippingPanel" runat="server" CssClass="dnnForm">
				<div class="rvdsfCheckoutBillingAndShippingContainer">
					<asp:Panel ID="AccountSectionPanel" runat="server">
						...
						<div class="rvdsfCheckoutAccountActions">
							<asp:HyperLink ID="AccountRegistrationHyperLink" runat="server" resourcekey="AccountRegistrationHyperLink" CssClass="btn btn-primary rvdsf-btn-register rvdRegisterAction" />
							<asp:HyperLink ID="AccountLoginHyperLink" runat="server" resourcekey="AccountLoginHyperLink" CssClass="btn btn-primary rvdsf-btn-login rvdLoginAction" />
						</div>
					</asp:Panel>
			   ...
			   { %>
					...
					<asp:Panel ID="OtherInformationPanel" runat="server">
						...
						<fieldset>
							<asp:Panel ID="CouponPanel" runat="server" CssClass="dnnFormItem">
								...
								<asp:LinkButton ID="AddCouponLinkButton" runat="server" OnClick="AddCouponLinkButton_Click" ValidationGroup="CouponCheckoutDisplayTemplate" CssClass="btn btn-primary" CausesValidation="True" resourcekey="ApplyLinkButton"></asp:LinkButton>
				...
				<div class="rvdsfCheckoutActions">
					<asp:LinkButton ID="ViewCartLinkButton" runat="server" OnClick="ViewCartLinkButton_Click" resourcekey="ViewCartLinkButton" CausesValidation="False" CssClass="btn btn-primary rvdsfViewCartAction" />
					<asp:LinkButton ID="ReviewOrderLinkButton" runat="server" OnClick="ReviewOrderLinkButton_Click" ValidationGroup="CheckoutDisplayTemplate" resourcekey="ReviewOrderLinkButton" CssClass="btn btn-primary rvdsfReviewOrderAction" />
				</div>
			</asp:Panel>
			<asp:Panel ID="PlaceOrderPanel" runat="server" CssClass="dnnForm dnnClear">
				...
				<asp:Panel ID="ReviewOrderPanel" runat="server" CssClass="rvdsfCheckoutReviewOrderContainer">
					...
					<div class="rvdsfCheckoutActions">
						<asp:LinkButton ID="EditCartLinkButton" runat="server" OnClick="EditCartLinkButton_Click" resourcekey="EditCartLinkButton" CausesValidation="False" CssClass="btn btn-primary rvdsfEditCartAction" />
					</div>
				</asp:Panel>
					...
					<asp:Panel ID="PaymentMethodsPanel" runat="server">
						<asp:Panel ID="RewardsPointPanel" runat="server">
							...
							<div class="dnnFormItem">
								...
								<asp:LinkButton ID="AddRewardsPointLinkButton" runat="server" OnClick="AddRewardsPointLinkButton_Click" ValidationGroup="RewardsPointCheckoutDisplayTemplate" CausesValidation="True" CssClass="btn btn-primary" resourcekey="ApplyLinkButton" />
						...
						<asp:Panel ID="VoucherPanel" runat="server">
							<div class="dnnFormItem">
								...
								<asp:LinkButton ID="AddVoucherLinkButton" runat="server" OnClick="AddVoucherLinkButton_Click" ValidationGroup="VoucherCheckoutDisplayTemplate" CausesValidation="True" CssClass="btn btn-primary" resourcekey="ApplyLinkButton" />
                        ...
                        <asp:Panel ID="ACHPanel" runat="server">
                            <div class="dnnFormItem">
                                ...
                                <asp:RequiredFieldValidator ID="InstitutionNameRequiredFieldValidator" resourcekey="InstitutionNameRequiredFieldValidator" runat="server" ControlToValidate="InstitutionNameTextBox" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" ValidationGroup="CheckoutDisplayTemplate"></asp:RequiredFieldValidator>
                            ...
                            <div class="dnnFormItem">
                                ...
                                <asp:RequiredFieldValidator ID="InstitutionNumberRequiredFieldValidator" resourcekey="InstitutionNumberRequiredFieldValidator" runat="server" ControlToValidate="InstitutionNumberTextBox" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" ValidationGroup="CheckoutDisplayTemplate"></asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="InstitutionNumberRegularExpressionValidator" runat="server" ControlToValidate="InstitutionNumberTextBox" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" ValidationExpression="[\d]{6,20}" ValidationGroup="CheckoutDisplayTemplate" resourcekey="InstitutionNumberRegularExpressionValidator"></asp:RegularExpressionValidator>
                            ...
                            <div class="dnnFormItem">
                                ...
                                <asp:RequiredFieldValidator ID="AccountNumberRequiredFieldValidator" runat="server" ControlToValidate="AccountNumberTextBox" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" ValidationGroup="CheckoutDisplayTemplate" resourcekey="AccountNumberRequiredFieldValidator"></asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="AccountNumberRegularExpressionValidator" runat="server" ControlToValidate="AccountNumberTextBox" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" ValidationExpression="[\d]{6,20}" ValidationGroup="CheckoutDisplayTemplate" resourcekey="AccountNumberRegularExpressionValidator"></asp:RegularExpressionValidator>
                            ...
                            <div class="dnnFormItem">
                                ...
                                <asp:CustomValidator runat="server" ID="ACHAgreementCustomValidator" EnableClientScript="true" ClientValidationFunction="ACHAgreementCustomValidator_ClientValidate" ValidationGroup="CheckoutDisplayTemplate" CssClass="dnnFormMessage dnnFormError" resourcekey="ACHAgreementCustomValidator" Display="Dynamic" />
                                <div class="rvdFormSubContainer">
						...
						<asp:Panel ID="PaymentProfilePanel" runat="server" CssClass="dnnFormItem">
							...
							<div class="rvdFormSubContainer">
								...
								<div class="rvdActions">
									...
									<asp:LinkButton ID="DeletePaymentLinkButton" runat="server" OnClick="DeletePaymentLinkButton_Click" CausesValidation="False" resourcekey="DeletePaymentLinkButton" CssClass="btn btn-default rvdDeleteAction" />
									<asp:LinkButton ID="UpdatePaymentLinkButton" runat="server" OnClick="UpdatePaymentLinkButton_Click" CausesValidation="False" resourcekey="UpdatePaymentLinkButton" CssClass="btn btn-default" Style="display: none" />
								</div>
							</div>
						</asp:Panel>
					</asp:Panel>
				...
				<div class="rvdsfCheckoutActions">
					<asp:LinkButton ID="ViewBillingLinkButton" runat="server" OnClick="ViewBillingLinkButton_Click" ValidationGroup="CheckoutDisplayTemplate" resourcekey="ViewBillingLinkButton" CausesValidation="False" CssClass="btn btn-primary rvdsfViewBillingAction" />
					<asp:LinkButton ID="PlaceOrderLinkButton" runat="server" OnClick="PlaceOrderLinkButton_Click" ValidationGroup="CheckoutDisplayTemplate" resourcekey="PlaceOrderLinkButton" OnClientClick="PlaceOrderLinkButton_ClientClick(this)" CssClass="btn btn-primary rvdsfPlaceOrderAction" />
					<asp:LinkButton ID="RequestQuoteLinkButton" runat="server" OnClick="RequestQuoteLinkButton_Click" ValidationGroup="CheckoutDisplayTemplate" resourcekey="RequestQuoteLinkButton" OnClientClick="PlaceOrderLinkButton_ClientClick(this)" CssClass="btn btn-primary rvdsfRequestQuoteAction" />
