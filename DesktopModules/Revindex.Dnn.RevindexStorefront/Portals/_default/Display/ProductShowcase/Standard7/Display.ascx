<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Display.ascx.cs" Inherits="Revindex.Dnn.RevindexStorefront.Portals._default.Display.ProductShowcase.Standard7.Display" %>
						...
						<div class="rvdsfProductDisplayContainer">
							...
							<div class="dnnForm rvdsfProductDisplayInfoContainer">
								...
								<div class="rvdsfProductDisplayActions">
									...
									<asp:LinkButton ID="AddToQuoteLinkButton" runat="server" resourcekey="AddToQuoteLinkButton" Visible='<%# Convert.ToBoolean(Eval("AddToQuoteLinkButton_Visible")) %>' ValidationGroup="ProductShowcaseDisplayTemplateControl" OnClientClick='<%# Eval("AddToQuoteLinkButton_OnClientClick") %>' CssClass="dnnPrimaryAction rvdsfAddToQuoteAction" />
									<asp:LinkButton ID="QuoteNowLinkButton" runat="server" resourcekey="QuoteNowLinkButton" Visible='<%# Convert.ToBoolean(Eval("QuoteNowLinkButton_Visible")) %>' ValidationGroup="ProductShowcaseDisplayTemplateControl" OnClientClick='<%# Eval("QuoteNowLinkButton_OnClientClick") %>' CssClass="dnnPrimaryAction rvdsfQuoteNowAction" />
								</div>
							</div>
						</div>
					</li>
