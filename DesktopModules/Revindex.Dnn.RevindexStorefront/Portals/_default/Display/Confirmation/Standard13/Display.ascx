<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Display.ascx.cs" Inherits="Revindex.Dnn.RevindexStorefront.Portals._default.Display.Confirmation.Standard13.Display" %>
...
<asp:Panel ID="ConfirmationPanel" runat="server" CssClass="rvdsfConfirmationContainer">
	...
	<asp:Panel ID="OrderConfirmationPanel" runat="server" CssClass="dnnForm">
		...
		<div class="rvdsfConfirmationActions">
			<asp:HyperLink ID="PrintHyperLink" runat="server" resourcekey="PrintHyperLink" CssClass="dnnPrimaryAction rvdPrintAction" Target="_blank"></asp:HyperLink>
