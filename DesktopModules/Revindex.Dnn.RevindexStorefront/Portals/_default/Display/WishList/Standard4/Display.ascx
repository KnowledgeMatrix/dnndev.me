<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Display.ascx.cs" Inherits="Revindex.Dnn.RevindexStorefront.Portals._default.Display.WishList.Standard4.Display" %>
						...
						<div class="rvdsfProductDisplayContainer">
							...
							<div class="rvdsfProductDisplayInfoContainer">
								...
								<div class="rvdsfProductDisplayActions">
									...
									<asp:LinkButton ID="QuoteNowLinkButton" runat="server" resourcekey="QuoteNowLinkButton" CssClass="dnnPrimaryAction rvdsfBuyNowAction" Visible='<%# Convert.ToBoolean(Eval("QuoteNowLinkButton_Visible")) %>' ValidationGroup="ProductListDisplayTemplateControl" CommandName="QuoteNow" CommandArgument='<%# Eval("ProductVariantID") %>' />
								</div>
							</div>
						</div>
					</ItemTemplate>
