<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Display.ascx.cs" Inherits="Revindex.Dnn.RevindexStorefront.Portals._default.Display.WishList.Standard2.Display" %>
						...
						<div class="rvdsfProductDisplayContainer">
							...
							<div class="rvdsfProductDisplayInfoContainer">
								...
								<div class="dnnFormItem rvdsfSalePriceAmount">
									...
									<asp:Label ID="SalePriceValueLabel" runat="server" Text='<%# Eval("SalePriceValueLabel_Text") %>'></asp:Label><asp:Label ID="SaleRecurringLabel" runat="server" CssClass="rvdsfSalePriceAmount" Text='<%# Eval("SaleRecurringLabel_Text") %>' Visible='<%# Convert.ToBoolean(Eval("SaleRecurringLabel_Visible")) %>'></asp:Label>
								</div>
								<div class='<%# String.Format("dnnFormItem rvdsfPriceAmount {0}", Eval("PriceValueLabel_CssClass")) %>' runat="server">
								...
								<div class="dnnFormItem rvdsfMSRPPriceAmount">
								...
								<div class="dnnFormItem rvdsfSavingsAmount">
								...
								<div class="dnnFormItem">
									<dnn1:LabelControl ID="QuantityLabelControl" runat="server" Visible='<%# Convert.ToBoolean(Eval("QuantityLabelControl_Visible")) %>' CssClass="dnnFormRequired"/>
									...
									<dnn2:DnnNumericTextBox ID="QuantityDnnNumericTextBox" runat="server" CssClass="rvdQuantityInput dnnFormRequired" Skin="" EnableSingleInputRendering="False" MinValue="1" Value='<%# Eval("QuantityDnnNumericTextBox_Value") %>' NumberFormat-DecimalDigits="0" NumberFormat-GroupSizes="9" Visible='<%# Convert.ToBoolean(Eval("QuantityDnnNumericTextBox_Visible")) %>' Enabled='<%# Convert.ToBoolean(Eval("QuantityDnnNumericTextBox_Enabled")) %>'>
