<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Display.ascx.cs" Inherits="Revindex.Dnn.RevindexStorefront.Portals._default.Display.ProductDetail.Standard19.Display" %>
		...
		<div class="rvdsfProductDisplayContainer">
			...
			<div class="dnnForm rvdsfProductDisplayInfoContainer">
				...
				<asp:ListView ID="ProductVariantSelectionListView" runat="server" OnItemDataBound="ProductVariantSelectionListView_ItemDataBound" DataKeyNames="ProductVariantGroupID,ProductVariantGroupFieldType">
					...
					<ItemTemplate>
						<div class="dnnFormItem rvdsfProductVariantGroupInput">
                            ...
                            <asp:BulletedList ID="SelectProductVariantImageSwatchBulletedList" runat="server" DisplayMode="HyperLink" CssClass="rvdFormImageSwatchList">
							</asp:BulletedList>
						</div>
					</ItemTemplate>
				</asp:ListView>
				...
				<div class="rvdsfProductDisplayActions dnnClear">
					<asp:LinkButton ID="AddToCartLinkButton" runat="server" resourcekey="AddToCartLinkButton" Visible="false" OnClick="AddToCartLinkButton_Click" CssClass="btn btn-primary rvdsfAddToCartAction" ValidationGroup="ProductDetailDisplayTemplateControl" />
					<asp:LinkButton ID="BuyNowLinkButton" runat="server" resourcekey="BuyNowLinkButton" Visible="false" OnClick="BuyNowLinkButton_Click" ValidationGroup="ProductDetailDisplayTemplateControl" CssClass="btn btn-primary rvdsfBuyNowAction" />
					<asp:LinkButton ID="AddToQuoteLinkButton" runat="server" resourcekey="AddToQuoteLinkButton" Visible="false" OnClick="AddToQuoteLinkButton_Click" CssClass="btn btn-primary rvdsfAddToQuoteAction" ValidationGroup="ProductDetailDisplayTemplateControl" />
					<asp:LinkButton ID="QuoteNowLinkButton" runat="server" resourcekey="QuoteNowLinkButton" Visible="false" OnClick="QuoteNowLinkButton_Click" ValidationGroup="ProductDetailDisplayTemplateControl" CssClass="btn btn-primary rvdsfQuoteNowAction" />
					<asp:LinkButton ID="AddToWishListLinkButton" runat="server" OnMouseOver="AddToWishListLinkButton_OnMouseOver(this)" CssClass="btn btn-primary rvdsfBuyNowAction" />
					<asp:LinkButton ID="UpdateLinkButton" runat="server" CssClass="btn btn-default rvdUpdateAction" resourcekey="UpdateLinkButton" ValidationGroup="ProductDetailDisplayTemplateControl" />
					<asp:HyperLink ID="ViewCartHyperLink" runat="server" CssClass="btn btn-default rvdsfViewCartAction" resourcekey="ViewCartHyperLink" />
					<asp:HyperLink ID="ContinueShoppingHyperLink" runat="server" CssClass="btn btn-default rvdsfContinueShoppingAction" resourcekey="ContinueShoppingHyperLink" />
				...
				<asp:Panel ID="ReviewsDetailsViewPanel" runat="server" CssClass="dnnClear rvdsfProductDisplayReviews">
					<asp:UpdatePanel ID="ProductReviewUpdatePanel" runat="server" UpdateMode="Conditional">
						<ContentTemplate>
							...
							<asp:LinkButton ID="AddProductReviewLinkButton" runat="server" resourcekey="AddProductReviewLinkButton" OnClick="AddProductReviewLinkButton_Click" CssClass="btn btn-default rvdAddNewAction" />
							<asp:Panel ID="AddProductReviewPanel" runat="server" Visible="False" CssClass="dnnForm">
								...
								<ul class="dnnActions dnnClear">
									<li>
										<asp:LinkButton ID="SaveAddProductReviewLinkButton" runat="server" resourcekey="SaveAddProductReviewLinkButton" OnClick="SaveAddProductReviewLinkButton_Click" ValidationGroup="AddProductReviewDetailDisplayTemplateControl" CssClass="btn btn-default rvdSaveAction" /></li>
								</ul>
							</asp:Panel>
