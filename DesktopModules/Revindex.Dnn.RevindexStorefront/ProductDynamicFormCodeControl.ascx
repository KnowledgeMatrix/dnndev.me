...
<div class="dnnFormItem">
	<dnn1:LabelControl ID="CodeTypeLabelControl" runat="server" Text="Dynamic form:" HelpText="Add custom fields to the product detail page to capture additional data using checkbox, dropdownlist, fileupload, textbox, etc." />
...
<asp:MultiView ID="FormulaMultiView" runat="server" ActiveViewIndex="0">
	...
	<asp:View ID="CustomCodeView" runat="server">
		<div class="dnnFormItem">
			...
			<uc1:DynamicFormCodeEditorControl ID="DynamicFormCodeEditor" runat="server" Width="100%" ModuleControl="Product" />
		</div>
	</asp:View>
</asp:MultiView>