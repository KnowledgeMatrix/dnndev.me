<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DistributorControl.ascx.cs" Inherits="Revindex.Dnn.RevindexStorefront.DistributorControl" %>
...
<asp:PlaceHolder ID="PlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        {
            jQuery('#DistributorDetailsViewTabPanel').dnnTabs();
        });
            ...
            <asp:MultiView ID="ContentMultiView" runat="server">
                <asp:View ID="ListView" runat="server">
                    ...
                    <div class="dnnForm rvdsfListContainer">
                        <asp:GridView ID="DistributorGridView" runat="server" CssClass="dnnGrid" GridLines="None" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="DistributorID" AllowPaging="True" OnRowDeleting="DistributorGridView_RowDeleting" OnRowDataBound="DistributorGridView_RowDataBound">
                        ...
                        <asp:ObjectDataSource ID="DistributorObjectDataSource" runat="server" EnablePaging="True" SelectCountMethod="GetCount" SelectMethod="GetAll" TypeName="Revindex.Business.Revindex.Revindex.Storefront.DistributorController" SortParameterName="sortExpression" DataObjectTypeName="Revindex.Business.Revindex.Revindex.Storefront.Distributor" DeleteMethod="Delete">
                            <SelectParameters>
                ...
                <asp:View ID="DetailsView" runat="server">
                    ...
                    <h2>Distributor: <uc1:BreadcrumbControl ID="BreadcrumbControl" runat="server" /></h2>
                    <div id="DistributorDetailsViewTabPanel" class="dnnForm">
                        ...
                        <asp:Panel ID="GeneralDetailsViewPanel" runat="server" CssClass="dnnClear">
                            <fieldset>
                                <div class="dnnFormItem">
                                    <dnn1:LabelControl ID="DistributorIDLabelControl" runat="server" Text="Distributor ID:" />
                                    <asp:Label ID="DistributorIDLabel" runat="server"></asp:Label>
                                </div>
								<asp:Panel ID="DistributorKeyPanel" runat="server" CssClass="dnnFormItem">
									<dnn1:LabelControl ID="DistributorKeyLabelControl" runat="server" Text="Distributor key:" CssClass="dnnFormRequired" HelpText="Enter a key that uniquely identifies this item throughout the system. The key could be your item name, SKU, any short meaningful text or simply a GUID value as long as the value is unique. The key is useful for bulk import and programming automation to help refer back to this item." />
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="DistributorKeyTextBox" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" ValidationExpression="[^;|\[\]&lt;&gt;{}^\\]+" ValidationGroup="DistributorDetailsViewControl">Key is invalid.</asp:RegularExpressionValidator>
                                    <asp:TextBox ID="DistributorKeyTextBox" runat="server" MaxLength="100" CssClass="dnnFormRequired"></asp:TextBox>
								</asp:Panel>
                                <div class="dnnFormItem">
                                    <dnn1:LabelControl ID="NameLabelControl" runat="server" Text="Name:" CssClass="dnnFormRequired" />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="NameTextBox" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" ValidationGroup="DistributorDetailsViewControl">Name is required.</asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="NameTextBox" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" ValidationExpression="[^;|\[\]&lt;&gt;{}^\\]+" ValidationGroup="DistributorDetailsViewControl">Name is invalid.</asp:RegularExpressionValidator>
                                ...
                                <div class="dnnFormItem">
                                    ...
                                    <asp:RegularExpressionValidator ID="EmailRegularExpressionValidator" runat="server" ControlToValidate="EmailTextBox" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" ValidationExpression="^(\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*|(&quot;*[\w ]*&quot;*\s*)&lt;\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*&gt;)$" ValidationGroup="DistributorDetailsViewControl">Email is invalid.</asp:RegularExpressionValidator>
                        ...
                        <asp:Panel ID="DisplayDetailsViewPanel" runat="server" CssClass="dnnClear">
                            <fieldset>
                                ...
                                <div class="dnnFormItem">
                                    <dnn1:LabelControl ID="DisplayTemplateLabelControl" runat="server" Text="Display template:" HelpText="The selected display template determines how to display the Product List module when this distributor is selected. Select a custom display template to associate to this distributor." />
                                ...
                                <div class="dnnFormItem">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="DisplayOrderDnnNumericTextBox" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" ValidationGroup="DistributorDetailsViewControl">Display order is required.</asp:RequiredFieldValidator>
                        ...
                        <asp:Panel ID="SEODetailsViewPanel" runat="server" CssClass="dnnClear">
                            <fieldset>
                                ...
                                <div class="dnnFormItem">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="MetaKeywordsTextBox" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" ValidationExpression="^[\s\S]{0,400}$" ValidationGroup="DistributorDetailsViewControl">Meta keywords is invalid.</asp:RegularExpressionValidator>
                                ...
                                <div class="dnnFormItem">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="MetaDescriptionTextBox" CssClass="dnnFormMessage dnnFormError" Display="Dynamic" ErrorMessage="*" ValidationExpression="^[\s\S]{0,400}$" ValidationGroup="DistributorDetailsViewControl">Meta description is invalid.</asp:RegularExpressionValidator>
                        ...
                        <asp:Panel ID="ExtensionDetailsViewPanel" runat="server" CssClass="dnnClear">
                            <fieldset>
                                <div class="dnnFormItem">
                                    ...
                                    <uc1:XmlEditorControl ID="ExtensionXmlEditor" runat="server" Width="100%" ModuleControl="DistributorExtension" />
                                </div>
                            </fieldset>
                        </asp:Panel>
                    </div>
                    <div class="dnnForm">
                        <ul class="dnnActions">
                            <li>
                                <asp:LinkButton ID="SaveLinkButton" runat="server" Text="Save" OnClick="SaveLinkButton_Click" CssClass="dnnPrimaryAction rvdSaveAction" ValidationGroup="DistributorDetailsViewControl" />
                            </li>
                            <li>
                                <asp:LinkButton ID="SaveAndBackLinkButton" runat="server" Text="Save & return" OnClick="SaveLinkButton_Click" CommandArgument="Back" CssClass="dnnPrimaryAction rvdSaveAction" ValidationGroup="DistributorDetailsViewControl" />
                            </li>
                            <li>
