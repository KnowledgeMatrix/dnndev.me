...
<asp:Panel ID="DetailsViewPanel" runat="server" CssClass="dnnForm">
	...
	<fieldset>
		<div class="dnnFormItem">
			<dnn1:LabelControl ID="DistributorDisplayTemplateLabelControl" runat="server" Text="Display template:"  HelpText="The selected display template determines how to display the Distributor module." />
			<uc1:DisplayTemplateDropDownListControl ID="DistributorDisplayTemplateDropDownListControl" runat="server" />
			<asp:LinkButton ID="DistributorDisplayTemplateLinkButton" runat="server" CssClass="rvdLinkAction" Text="Edit" OnClick="DistributorDisplayTemplateLinkButton_Click" CausesValidation="False" />
		</div>
	</fieldset>
	<script type="text/javascript">
	...
	<fieldset>
		...
		<div class="rvdsfFeaturesContainer">
			<div class="dnnFormItem">
				<dnn1:LabelControl ID="DistributorExtensionActiveLabelControl" runat="server" Text="Extensions:" HelpText="Allow storing additional data."/>
