<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductVariantAvailabilityRuleControl.ascx.cs" Inherits="Revindex.Dnn.RevindexStorefront.ProductVariantAvailabilityRuleControl" %>
...
<div class="dnnFormItem">
	<dnn1:LabelControl ID="RuleTypeLabelControl" runat="server" Text="Availability rule:" HelpText="Provide any condition that determines when this product should be available for purchase." />
...
<asp:MultiView ID="FormulaMultiView" runat="server" ActiveViewIndex="0">
	...
	<asp:View ID="CustomRuleView" runat="server">
		<div class="dnnFormItem">
			...
			<uc1:FormulaEditorControl ID="AvailabilityRuleFormulaEditor" runat="server" Width="100%" ModuleControl="ProductVariantAvailability" />
		</div>
	</asp:View>
</asp:MultiView>