<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SetRevindexStorefrontCartSummary.ascx.cs" Inherits="Revindex.Dnn.RevindexStorefront.SetRevindexStorefrontCartSummary" %>
