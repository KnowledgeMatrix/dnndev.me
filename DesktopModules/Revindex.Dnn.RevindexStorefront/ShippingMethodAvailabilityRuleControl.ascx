<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ShippingMethodAvailabilityRuleControl.ascx.cs" Inherits="Revindex.Dnn.RevindexStorefront.ShippingMethodAvailabilityRuleControl" %>
...
<div class="dnnFormItem">
	<dnn1:LabelControl ID="RuleTypeLabelControl" runat="server" Text="Availability rule:" />
...
<asp:MultiView ID="FormulaMultiView" runat="server" ActiveViewIndex="0">
	<asp:View ID="BasicAvailabilityView" runat="server">
		<div class="dnnFormItem">
			<dnn1:LabelControl ID="MinOrderAmountBasicAvailabilityLabelControl" runat="server" Text="Min total amount:" HelpText="The minimum total order amount to qualify for this shipping method." />
		...
		<div class="dnnFormItem">
			<dnn1:LabelControl ID="MaxOrderAmountBasicAvailabilityLabelControl" runat="server" Text="Max total amount:" HelpText="The maximum total order amount to qualify for this shipping method." />
		...
		<div class="dnnFormItem">
			<dnn1:LabelControl ID="MinOrderQuantityBasicAvailabilityLabelControl" runat="server" Text="Min total quantity:" HelpText="The minimum total order quantity to qualify for this shipping method." />
		...
		<div class="dnnFormItem">
			<dnn1:LabelControl ID="MaxOrderQuantityBasicAvailabilityLabelControl" runat="server" Text="Max total quantity:" HelpText="The maximum total order quantity to qualify for this shipping method." />
		...
		<div class="dnnFormItem">
			<dnn1:LabelControl ID="MinOrderWeightBasicAvailabilityLabelControl" runat="server" Text="Min total weight ({0}):" HelpText="The minimum total weight to qualify for this shipping method." />
		...
		<div class="dnnFormItem">
			<dnn1:LabelControl ID="MaxOrderWeightBasicAvailabilityLabelControl" runat="server" Text="Max total weight ({0}):" HelpText="The maximum total weight to qualify for this shipping method." />
		...
		<div class="dnnFormItem">
			...
			<asp:RadioButtonList ID="RegionBehaviorBasicAvailabilityRadioButtonList" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" CssClass="dnnFormRadioButtons">
		...
		<div class="dnnFormItem">
			<dnn1:LabelControl ID="RegionBasicAvailabilityLabelControl" runat="server" Text="Regions:" HelpText="Availability is determined by the customer's shipping address." />
			<div class="rvdFormSubContainer">
				...
				<div class="rvdActions">
					<asp:LinkButton ID="AddRegionBasicAvailabilityLinkButton" runat="server" Text="Add new" OnClick="AddRegionBasicAvailabilityLinkButton_Click" CausesValidation="false" CssClass="dnnPrimaryAction rvdAddNewAction" />
				</div>
	...
	<asp:View ID="CustomRuleView" runat="server">
		<div class="dnnFormItem">
			...
			<uc1:FormulaEditorControl ID="AvailabilityRuleFormulaEditor" runat="server" Width="100%" ModuleControl="ShippingMethodAvailability" />
		</div>
	</asp:View>
</asp:MultiView>