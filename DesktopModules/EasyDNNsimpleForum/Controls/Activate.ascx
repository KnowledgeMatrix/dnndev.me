<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Activate.ascx.cs" Inherits="EasyDNNSolutions.Modules.EasyDNNsimpleForum.Controls.Activate" %>
	...
	#EDSadmin {
		...
		#EDSadmin .main_content {
			...
			#EDSadmin .main_content input {
				...
				#EDSadmin .main_content input.eds_blueButton {
					...
					#EDSadmin .main_content input.eds_blueButton:hover {
	...
	<div class="module_settings">
		<div class="settings_category_container">
			<div class="category_toggle">
				<h2>EasyDNNsimpleForum Activation</h2>
			</div>
			<table border="0" class="main_content grid_view_table" width="100%">
				...
				<tr>
					<td colspan="2" style="text-align: center;">
						<asp:Button ID="btnActivate" CssClass="eds_blueButton" runat="server" OnClick="btnActivate_Click" Text="Activate" />
					</td>
				</tr>
				<tr>
					<td colspan="2">
				...
				<tr>
					<td colspan="2" style="text-align: center;">
						<asp:Button ID="btnCloseActivation" CssClass="eds_blueButton" runat="server" OnClientClick="openMoreInfo();" Text="OK" OnClick="btnCloseActivation_Click" Visible="False" />
