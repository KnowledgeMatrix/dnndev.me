<%@ control language="C#" inherits="EasyDNNSolutions.Modules.EasyDNNstyleWizard.Activate, App_Web_activate.ascx.794c5fcb" autoeventwireup="true" %>
	...
	<div class="module_settings">
		<div class="settings_category_container">
			<div class="category_toggle">
				<h2>EasyDNNstyleWizard Activation</h2>
			</div>
			<table border="0" class="main_content grid_view_table" width="100%">
				...
				<tr>
					<td colspan="2" style="text-align:center;">
						<asp:Button ID="btnCloseActivation" runat="server" Text="OK" OnClientClick="openMoreInfo();" OnClick="btnCloseActivation_Click" Visible="False" />
