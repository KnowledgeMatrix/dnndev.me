...
define(['jquery', 'knockout',
        ...
        function ($, ko, pikaday, d3, moment, d3Charts, pager, scroller, tabPanel) {
            ...
            var analytics = function () {
                ...
                var adjustMetricBoxes = function() {
                    //Adjust the height of the metric boxes if some have multi-line titles. 
                    //- timeout allows boxes to load before adjustments
                    setTimeout(function() {
                        var max = 0;
                        $('.siteMetrics > div').each(function() {
                            var spanHeight = $(this).children('span.metric-name').height();
                            max = spanHeight > max ? spanHeight : max;
                        });
                        $('.siteMetrics > div span.metric-name').each(function() {
                            if ($(this).height() < max) {
                                $(this).css("line-height", max + "px");
                            }
                        });
                    }, 1);
                };
                ...
                var init = function (wrap, util, params, callback, viewModelParam) {
                    window.require(['css!main/../modules/evoq.CommunityAnalytics/css/analytics.css']);
                    ...
                    contentResx = utility.resx.CommunityAnalytics;
                    ...
                    viewModel.showCustomCalendar = function (vm, e) {
                        ...
                        wrapper.find('.pika-calendar-apply-btn');

                        pikerContainer.appendTo($(e.target).parent().parent());
                        pikerContainer.show();
                    ...
                    utility.asyncParallel([
                        ...
                        if (typeof callback === 'function') callback(wrap);
                    });
                ...
                var updateChannelsGraph = function (labels, channels, animation, channelsLabels, channelsTooltips) {
                    var root = (analyticsMode == "page") ? "#page-traffic" : "#site-traffic";
                ...
                var updateNavigationSummary = function (navigationSummary) {
                    var container = "#page-traffic #navigation-summary .chart-container > div",
