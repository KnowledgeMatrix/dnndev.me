        ...
        DnnPageRecycleBin = (function () {
            ...
            function DnnPageRecycleBin(resx, serviceController, utility, options, settings) {
                ...
                _settings = {
                    ...
                    canViewTemplates: settings.isHost || settings.isAdmin || settings.permissions.RECYCLEBIN_TEMPLATES_VIEW,
                    ...
                    canManageTemplates: settings.isHost || settings.isAdmin || settings.permissions.RECYCLEBIN_TEMPLATES_EDIT,
                    canEmptyRecycleBin: settings.isHost || settings.isAdmin || (settings.permissions.RECYCLEBIN_PAGES_VIEW && settings.permissions.RECYCLEBIN_PAGES_EDIT && settings.permissions.RECYCLEBIN_MODULES_VIEW && settings.permissions.RECYCLEBIN_MODULES_EDIT && settings.permissions.RECYCLEBIN_USERS_VIEW && settings.permissions.RECYCLEBIN_USERS_EDIT && settings.permissions.RECYCLEBIN_TEMPLATES_VIEW && settings.permissions.RECYCLEBIN_TEMPLATES_EDIT)
                };
            }
            ...
            restoreSelectedTemplatesHandler = function () {
                if (_settings.canViewTemplates && _settings.canManageTemplates) {
                    ...
                    if (templatesList.length > 0) {
                        ...
                        _utility.confirm(confirmText, yesText, noText, function () {
                            getService().post('RestoreTemplate', templatesList, function () {
            ...
            removeSelectedTemplatesHandler = function () {
                if (_settings.canViewTemplates && _settings.canManageTemplates) {
                    ...
                    if (templatesList.length > 0) {
                        ...
                        _utility.confirm(confirmText, yesText, noText, function () {
                            getService().post('RemoveTemplate', templatesList, function () {
                                for (var i = 0; i < templatesList.length; i++) {
                                    viewModel.deletedtemplatesList.remove(templatesList[i]);
                                }
                            });
            ...
            restoreTemplateHandler = function (templateData, e) {
                if (_settings.canViewTemplates && _settings.canManageTemplates) {
                    ...
                    _utility.confirm(confirmText, yesText, noText, function () {
                        ...
                        getService().post('RestoreTemplate', templateList, function () {
            ...
            removeTemplateHandler = function (templateData, e) {
                if (_settings.canViewTemplates && _settings.canManageTemplates) {
                    ...
                    _utility.confirm(confirmText, yesText, noText, function () {
                        var templateList = [];
                        templateList.push({ id: templateData.id });
                        getService().post('RemoveTemplate', templateList, function () {
                            viewModel.deletedtemplatesList.remove(templateData);
                        });
                    });
                }
            ...
            getViewModel = function () {
                if (!_viewModel) {
                    ...
                    if (_settings.canViewPages && _settings.canManageTemplates) {
                        _viewModel.selectAllPages.subscribe(function (newValue) {
                            markAllElementsAs(_viewModel.deletedpagesList(), newValue);
                        });
                    }
                    if (_settings.canViewTemplates && _settings.canManageUsers) {
            ...
            getService = function () {
                ...
                _utility.sf.controller = "EvoqRecyclebin";
