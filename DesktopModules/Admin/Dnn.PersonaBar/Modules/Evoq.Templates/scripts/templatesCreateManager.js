...
function ($, ko, koMapping) {
    ...
    getService = function () {
        serviceController.moduleRoot = "personaBar";
        serviceController.controller = "Templates";
    ...
    init = function (service, params, resx) {
        ...
        viewModel = {
            ...
            canEdit: function() {
                return params.settings &&
                        (params.settings.isHost || params.settings.isAdmin || (params.settings.permissions && params.settings.permissions.EDIT === true));
            }
        };
