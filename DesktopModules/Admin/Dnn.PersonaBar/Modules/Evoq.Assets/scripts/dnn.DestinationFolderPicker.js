...
(function ($, window, document, undefined) {
    ...
    //
    var DestinationFolderPicker = this.DestinationFolderPicker = function (element, options, controller) {
    ...
    DestinationFolderPicker.prototype = {

        constructor: DestinationFolderPicker,

        init: function () {
            // Place initialization logic here
            // You already have access to the DOM element and the options via the instance, 
            // e.g., this.element and this.options
            this.options = $.extend({}, DestinationFolderPicker.defaults(), this.options);
        ...
        _onSelectNode: function(eventObject, node) {
            this.options.onSelectedFolder(node.data.id);
        },
    ...
    DestinationFolderPicker._defaults = {
    ...
    DestinationFolderPicker.defaults = function (settings) {
        if (typeof settings !== "undefined") {
            $.extend(DestinationFolderPicker._defaults, settings);
        }
        return DestinationFolderPicker._defaults;
    };
...
dnn.createDestinationFolderPicker = function (element, options, methods) {
    $(document).ready(function () {
        ...
        var instance = new dnn.DestinationFolderPicker(element, options);

        instance._openItemList();
