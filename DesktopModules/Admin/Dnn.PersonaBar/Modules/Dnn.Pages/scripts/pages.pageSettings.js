...
define(['jquery', 'knockout', 'main/config', 'pikaday', 'moment', './pages.thumbnails', 'knockout.validation.min',
    'main/koComponents/dateTimePicker'], function ($, ko, cf, pikaday, moment) {
    var config = cf.init();
    ...
    pageSettingsManager.prototype = {
        ...
        _getService: function () {
            this.serviceController.moduleRoot = "personaBar";
