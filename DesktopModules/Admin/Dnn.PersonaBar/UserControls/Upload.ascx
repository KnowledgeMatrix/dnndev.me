<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Upload.ascx.cs" Inherits="Evoq.PersonaBar.UI.admin.personaBar.UserControls.Upload" %>
...
<asp:Panel ID="ScopeWrapper" runat="server" CssClass="upload">
    ...
    <div id="stored-location" class="stored-location" data-bind="visible: activeTab() == 'stored-location'">
        ...
        <div class="stored-location-list" data-bind="foreach: storedFiles">
            <span class="thumb_wrapper" data-bind="css: { checked:  $root.isFileSelected(id) }, click: $root.itemClick">
                <span class="thumb_holder">
                    <img data-bind="attr: { src: thumb, rel: thumb, title: title, alt: title }">
        ...
        <div class="buttons">
            <a href="javascript:void(0);" class="insert-image" data-bind="click: insertFileClicked, text: insertFileLiteral"></a>            
        </div>
    </div>
    <div id="from-url" class="from-url" data-bind="visible: activeTab() == 'from-url'">
        ...
        <div data-bind="visible: !uploadingFromUrl()">
            ...
            <input type="text" id="file-url" data-bind="value: uploadUrl, valueUpdate: 'afterkeydown', css: { error: uploadUrl() != '' && !previewAvailable() }" aria-label="File">
