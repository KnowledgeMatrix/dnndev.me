(function ($) {
    ...
    */
    ...
    $.mcDropDownMenu = function (el, list, options) {
        ...
        //mcavoym
        //bug fix for FF not picking up the size
        //of the objec when in an Iframe
        if (di.width == 0) di.width = 400;
        if (di.height == 0) di.height = 20;
        ...
        function getListDimensions($el, cols) {
            if (!$el.data("dimensions")) {
                ...
                //mcavoym
                //bug fix to get it to work in FF when the page is
