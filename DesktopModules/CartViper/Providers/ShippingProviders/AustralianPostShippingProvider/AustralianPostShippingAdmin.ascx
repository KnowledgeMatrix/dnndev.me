<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AustralianPostShippingAdmin.ascx.cs" Inherits="CartViper.Store.Providers.Shipping.AustralianPostShippingProvider.AustralianPostShippingAdmin" %>
    ...
    <table width="100%">
        ...
        <tr>
            <td style="width:250px">
                <dnn:label resourcekey="lblApiKey" id="lblApiKey" runat="server" controlname="txtApiKey" suffix=":"></dnn:label>
            </td>
            <td>
                <asp:TextBox runat="server" ID="txtApiKey" Width="300"></asp:TextBox>
                <asp:RequiredFieldValidator resourcekey="rf" runat="server" ID="rfApiKey" ControlToValidate="txtApiKey"></asp:RequiredFieldValidator>
            </td>
        </tr>
