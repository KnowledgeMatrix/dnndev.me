<%@ Control language="c#" CodeBehind="TotalWebSolutionsAdmin.ascx.cs" Inherits="CartViper.Store.TotalWebSolutionProvider.TotalWebSolutionsAdmin" AutoEventWireup="True" %>
