<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VirtualMerchantPayment.ascx.cs" Inherits="CartViper.Store.Cart.VirtualMerchant.VirtualMerchantPayment" %>
