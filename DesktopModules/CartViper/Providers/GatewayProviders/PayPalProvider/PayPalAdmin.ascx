<%@ Control language="c#" CodeBehind="PayPalAdmin.ascx.cs" Inherits="CartViper.Store.PaymentProviders.PaypalProvider.PayPalAdmin" AutoEventWireup="True" %>
...
<table style="text-align:left;">
    ...
    <tr>
        <td class="NormalBold" style="width:180px; vertical-align:top">
            <dnn:label id="lblPaypalProAccount" runat="server" controlname="chkPaypalProAccount" suffix=":"></dnn:label>
        </td>
        <td>
            <asp:CheckBox runat="server" ID="chkPaypalProAccount" />
        </td>
    </tr>
	<tr>
		<td class="NormalBold" style="width:180px; vertical-align:top;">
