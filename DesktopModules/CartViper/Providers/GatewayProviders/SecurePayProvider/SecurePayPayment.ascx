<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SecurePayPayment.ascx.cs" Inherits="CartViper.Store.Cart.SecurePayProvider.SecurePayPayment" %>

<asp:Panel id="pnlProceedToSecurePay" runat="server" Visible="true" CssClass="StoreAccountCheckoutSecurePayProvider cvStoreOnlinePaymentProvider">
	<fieldset>
		<legend>
		...
		<table class="StoreAccountCheckoutSecurePayCardInfos">
			<tr id="trCardType" runat="server" visible="false">
				<td class="StoreAccountCheckoutSecurePayCardLabel">
					<asp:Label id="lblCard" CssClass="SubHead" runat="server">Card Type:</asp:Label>
				</td>
				<td class="StoreAccountCheckoutSecurePayCardValue">
