<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EwayDirectPaymentsPayment.ascx.cs" Inherits="CartViper.Store.Cart.EwayDirectPaymentsProvider.EwayDirectPaymentsPayment" %>

<asp:Panel id="pnlProceedToEway" runat="server" Visible="true" CssClass="StoreAccountCheckoutEwayMerchantProvider cvStoreOnlinePaymentProvider">
    <fieldset>
        <legend>
