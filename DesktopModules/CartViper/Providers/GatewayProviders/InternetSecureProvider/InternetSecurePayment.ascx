<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InternetSecurePayment.ascx.cs" Inherits="CartViper.Store.Cart.InternetSecure.InternetSecurePayment" %>
...
<asp:Panel id="pnlProceedToAuthorize" runat="server" Visible="true" CssClass="StoreAccountCheckoutAuthorizeProvider cvStoreOnlinePaymentProvider">
    <fieldset>
        ...
        <table class="StoreAccountCheckoutAuthorizeCardInfos">
            <tr id="trNameOnCard" runat="server">
                <td class="StoreAccountCheckoutAuthorizeCardLabel">
			        <asp:Label id="lblName" runat="server">Name on Card:</asp:Label>
                </td>
                <td class="StoreAccountCheckoutAuthorizeCardValue">
			        <asp:TextBox id="txtName" runat="server" CssClass="NormalTextBox" Width="150px" MaxLength="255"></asp:TextBox>
