<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PayPalPayflowProPayment.ascx.cs" Inherits="CartViper.Store.Cart.PayPalPayflowProProvider.PayPalPayflowProPayment" %>
...
<fieldset>
    ...
    <table style="text-align:left">
        ...
        <asp:Panel runat="server" ID="pnlUkDetails" Visible="false">
          <tr>
            <td style="width:130px">
