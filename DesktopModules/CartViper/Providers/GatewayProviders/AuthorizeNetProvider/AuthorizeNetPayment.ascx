<%@ Control language="c#" CodeBehind="AuthorizeNetPayment.ascx.cs" Inherits="CartViper.Store.PaymentProviders.AuthorizeNetProvider.AuthorizeNetPayment" AutoEventWireup="True" %>
