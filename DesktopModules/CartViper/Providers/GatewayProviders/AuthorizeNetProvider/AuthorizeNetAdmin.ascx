<%@ Control language="c#" CodeBehind="AuthorizeNetAdmin.ascx.cs" Inherits="CartViper.Store.PaymentProviders.AuthorizeNetProvider.AuthorizeNetAdmin" AutoEventWireup="True" %>
