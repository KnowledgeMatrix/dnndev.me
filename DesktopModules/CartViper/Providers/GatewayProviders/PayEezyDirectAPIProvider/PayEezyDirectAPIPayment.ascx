<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PayEezyDirectAPIPayment.ascx.cs" Inherits="CartViper.Store.PaymentProviders.PayEezyDirectAPIProvider.PayEezyDirectAPIPayment" %>
...
<asp:Panel id="pnlProceedToAuthorize" runat="server" Visible="true" CssClass="StoreAccountCheckoutAuthorizeProvider cvStoreOnlinePaymentProvider">
    <fieldset>
        ...
        <table class="StoreAccountCheckoutAuthorizeCardInfos">
            <tr id="trCardType" runat="server" visible="true">
                ...
                <td class="StoreAccountCheckoutAuthorizeCardValue">
                    <asp:DropDownList id="ddlCard" CssClass="Normal" runat="server">
                        ...
                        <asp:ListItem Value="DinersClub">Diners Club</asp:ListItem>
                        <asp:ListItem Value="Discover">Discover</asp:ListItem>
                    </asp:DropDownList>
				    <asp:RequiredFieldValidator ValidationGroup="cvCheckout" id="rfvCard" runat="server" ControlToValidate="ddlCard" CssClass="NormalRed">* Required</asp:RequiredFieldValidator>
                </td>
            </tr>
