<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ActivationManager.ascx.cs"
    Inherits="Mandeeps.DNN.Modules.LiveAccordion.Licensing.ActivationManager" %>
    ...
    <asp:MultiView ID="mView" runat="server" ActiveViewIndex="0">
        <asp:View ID="viewMenu" runat="server">
            <div style="text-align: center">
                ...
                <a id="bPurchaseKeyLink" runat="server" href="#">
                    <img id="bPurchaseKeyImage" style="vertical-align: top; border: 0;" src="~/ActivationManager/PurchaseKey.jpg"
                        alt="Purchase License" runat="server" /></a> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:View ID="viewRequestKey" runat="server">
            <div style="text-align: center">
                ...
                &nbsp;<asp:TextBox ID="tbEmail" runat="server" Width="300px" CssClass="MNormalTextBox"></asp:TextBox>
                &nbsp;<br />
                <br />
                <MButton:PostBackLinkButton ID="bRequestKeySubmit" runat="server" Text="Request Activation Key"
        ...
        <asp:View ID="viewApplyKey" runat="server">
            <div style="text-align: center">
                ...
                &nbsp;<asp:TextBox ID="tbActivationKey" runat="server" Width="300px" CssClass="MNormalTextBox"></asp:TextBox>
                &nbsp;<br />
                <br />
