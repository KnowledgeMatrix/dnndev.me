...
if (typeof dnn.dnnExistingModuleDialog === "undefined") {
    (function ($) {
        ...
        dnnExistingModuleDialog.prototype = {
            ...
            _createPagesDropdown: function () {
                var handler = this;
                var isInPortalGroup = dnn.getVar('cem_isInPortalGroup').toLowerCase();
                ...
                if (isInPortalGroup === "true") {
                    $.extend(true, pagePickerOptions.services, {
                        getTreeMethod: 'ItemListService/GetPagesInPortalGroup',
                        sortTreeMethod: 'ItemListService/SortPagesInPortalGroup',
                        getNodeDescendantsMethod: 'ItemListService/GetPageDescendantsInPortalGroup',
