...
﻿                    if (this._loadMore) {
﻿                        var isAdmin = dnn.getVar('cem_isAdmin') === "True";
...
﻿                        }
﻿                        if (htmlModuleId > -1) {
﻿                            var $htmlItem = this._dialogLayout.find('.listAll .dnnModuleItem[data-moduleid="' + htmlModuleId + '"]');
...
﻿                                    layoutModuleId = data[i].ModuleID;
﻿                                }
﻿                            }
﻿                        }
﻿                        if (layoutModuleId > -1) {
﻿                            var $layoutItem = this._dialogLayout.find('.listAll .dnnModuleItem[data-moduleid="' + layoutModuleId + '"]');
﻿                            $layoutItem.parent().prepend($layoutItem);
﻿                        }
...
﻿                    $('<a name="' + moduleId + '" href="#" class="cancel-module" data-moduleid="' + moduleId + '" aria-label="Cancel" />').appendTo($dragContent).click($.proxy(handler._cancelAddModule, handler));
﻿                };
﻿                initFloatingContent();
