...
(function IIFE() {
    ...
    PageWorkflowManagerClass = (function IIFE() {
        ...
        _imageCallbackInfo = {};
        _htmlSubmit = '<div class="PageWorkflowMangaer message"><textarea rows="8" data-bind="value: message, valueUpdate: \'afterkeydown\'" aria-label="Comment"></textarea></div>';

        _htmlApprovalReject =   '<div class="EditBarDialog message" data-bind="css: browser">' +
                                    '<textarea rows="8" data-bind="value: message, valueUpdate: \'afterkeydown\'" aria-label="Comment"></textarea>' +
                                ...
                                //TODO Remove after testing
                                    ...
                                    '<div class="fileUploadZone" data-bind="fileUpload, visible: dropZoneAvailable()">' +
                                        '<input type="file" class="uploadFileInput normalFileUpload" aria-label="File" />' +
