...
// NOTES (by Richard) I cleaned timepicker js to make it looks same as RadTimepicker from dnn default.
...
(function ($) {
    ...
    function Timepicker() {
        ...
        this._defaults = { // Global defaults for all the time picker instances
            ...
            showLeadingZero: false,          // Define whether or not to show a leading zero for hours < 10. [true/false]
    ...
    $.extend(Timepicker.prototype, {
        ...
        _generateHTML: function (inst) {
            ...
            html += '<td class="ui-timepicker-title">Time Picker</td></tr><tr><td>';
            ...
            if (showHours) {
                ...
                html += '<table class="ui-timepicker-content">';
                ...
                for (row = 1; row <= 6; row++) {
                    ...
                    */
                    for (col = 1; col <= 4; col++) {
                        ...
                        //} else {
                        html += this._generateHTMLHourCell(inst, hours[hourCounter], showPeriod, showLeadingZero, amPmText);
                            hourCounter++;
                        //}
                    }
                    html += '</tr>';
...
*/
        ...
        _generateHTMLHourCell: function (inst, hour, showPeriod, showLeadingZero, amPmText) {

            var ampm = '', displayHour = hour;
            if (showPeriod) {
                ampm = amPmText[0];
                if (hour >= 12) {
                    displayHour = hour - 12;
