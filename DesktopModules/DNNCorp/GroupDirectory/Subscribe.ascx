<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="Subscribe.ascx.cs" Inherits="DotNetNuke.Professional.GroupDirectory.Subscribe" %>
<%@ Import Namespace="DotNetNuke.Services.Localization" %>
<asp:Panel runat="server" ID="ScopeWrapper" CssClass="dnnClear">   
	<div class="dnnClear moduleSubscribe status-compact-container status-container" id="divSubscribe">
...
<script type='text/javascript'>
    function groupDirectorySubscribeView(settings) {
        ...
        try {
            window.dnn.social.applyBindings(new window.dnn.groupDirectory.Subscribe($, ko, settings), settings.moduleScope);
