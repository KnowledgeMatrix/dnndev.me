<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="Subscribe.ascx.cs" Inherits="DotNetNuke.Professional.Challenges.Subscribe" %>
<%@ Import Namespace="DotNetNuke.Services.Localization" %>
<asp:Panel runat="server" ID="ScopeWrapper" CssClass="dnnClear">   
	<div class="dnnClear moduleSubscribe status-compact-container status-container" id="challengesSubscribe">
...
<script type='text/javascript'>
    function challengesSubscribeView(settings) {
        ...
        try {
            window.dnn.social.applyBindings(new window.dnn.challenges.Subscribe($, ko, settings), settings.moduleScope);
