...
(function (dnn) {
    ...
    dnn.challenges.ListController = function ListController($, ko, settings, social) {
        var that = this;
                ...
                function (m) {
                    ...
                    $.each(m.Results,
                        function (index, model) {
                            results.push(new dnn.challenges.Challenge($, ko, settings, social, model));
                        });
                    ...
                    if (appendToOriginalSets) {
                        ...
                        for (var i = 0; i < results.length; i++) {
                            ...
                            $.each(that.resultsMobile(),
                                function (index, p) {
                                    if (p.contentItemId() === results[i].contentItemId()) {
                                        exists = true;
                                        return false;
                                    }
                                    return true;
