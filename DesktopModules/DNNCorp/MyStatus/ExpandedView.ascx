<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExpandedView.ascx.cs" Inherits="DotNetNuke.Professional.MyStatus.ExpandedView" %>
...
<div class="profileContainer status-expanded-container moduleContainer" id="dnnExpandedStatus">
    ...
    <div class="dnnMobile-profile-container" data-bind="with: profile">
        ...
        <div class="reportUser dnnRight" id="reportUserMobile" runat="server" >
            <a class="idea-report dnnSocialLink" href="javascript:void(0)" data-bind="click: $root.reportUser">
                <span><%= LocalizeString("ReportUser") %></span>
            </a>            
        </div>    
