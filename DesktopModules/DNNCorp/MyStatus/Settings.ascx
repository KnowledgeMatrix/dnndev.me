...
<fieldset>
    ...
    <div class="dnnFormItem">
        ...
        <asp:TextBox runat="server" ID="ctlColor1" CssClass="dnnLeft dnnColorPicker"></asp:TextBox>
    </div>
    <div class="dnnFormItem">
        <dnn:Label ResourceKey="Color2" runat="server" /> 
        <asp:TextBox runat="server" ID="ctlColor2" CssClass="dnnLeft dnnColorPicker"></asp:TextBox>
    </div>
</fieldset>
<script type="text/javascript">
    (function($) {
        $(document.body).ready(function() {
            $(".dnnColorPicker").spectrum({
                showInput: true,
                ...
                maxSelectionSize: 10,
                preferredFormat: "hex",
                localStorageKey: "dnn.engage.colorpicker",
                move: function (color) {
