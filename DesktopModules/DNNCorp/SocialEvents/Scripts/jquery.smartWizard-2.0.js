    ...
    $.fn.smartWizard = function (action) {
        ...
        return this.each(function () {
            ...
            function init() {
                ...
                elmActionBar.append(btPrevious).append(btNext).append(btFinish);
            ...
            function SetupStep(curStep, selStep, stepIdx) {
                ...
                $('.socialEventsWizardStepArrow', $(steps, obj)).css('background-position', '0 -401px');
                ...
                $('.socialEventsWizardStepArrow', $(selStep, obj)).css('background-position', '0 -299px');
                if (stepIdx > 0) {
                    stepIdx--;
                    var prevStep = steps.eq(stepIdx);
                    $('.socialEventsWizardStepArrow', $(prevStep, obj)).css('background-position', '0 -201px');
                }
            ...
            function adjustButton() {
                if (!options.cycleSteps) {
                    ...
                    if ((steps.length - 1) <= curStepIdx) {
                        $(btNext).removeClass("buttonHighlight").addClass("buttonDisabled");
                    } else {
                        $(btNext).removeClass("buttonDisabled").addClass("buttonHighlight");
                    }
                }
                // Finish Button 
                if (!steps.hasClass('disabled') || options.enableFinishButton) {
                    $(btNext).removeClass("buttonHighlight");
                    $(btFinish).removeClass("buttonDisabled").addClass("buttonHighlight");
                } else {
                    $(btFinish).removeClass("buttonHighlight").addClass("buttonDisabled");
                }
            }
