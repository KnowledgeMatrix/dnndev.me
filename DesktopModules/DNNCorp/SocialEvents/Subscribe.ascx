<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="Subscribe.ascx.cs" Inherits="DotNetNuke.Professional.SocialEvents.Subscribe" %>
<%@ Import Namespace="DotNetNuke.Services.Localization" %>
<asp:Panel runat="server" ID="ScopeWrapper" CssClass="dnnClear">   
	<div class="dnnClear moduleSubscribe status-compact-container status-container" id="eventsSubscribe">
...
<script type='text/javascript'>
    function seventsSubscribeView(settings) {
        ...
        try {
            window.dnn.social.applyBindings(new window.dnn.socialevents.Subscribe($, window.ko, settings), settings.moduleScope);
