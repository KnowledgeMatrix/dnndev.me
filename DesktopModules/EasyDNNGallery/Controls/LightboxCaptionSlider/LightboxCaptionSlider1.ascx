																...
																<div class="EDGimage">
																	...
																	<a id="A1" href="" runat="server">
																		<asp:ImageButton ID="ibNestedGallery" runat="server" CommandName="OpenNestedGallery"
																			CommandArgument='<%#Eval("GalleryID")%>' ImageUrl='<%#GetGalleryThumbPath(DataBinder.Eval(Container.DataItem, "GalleryID")) %>' AlternateText='<%#EasyDNN.Modules.EasyDNNGallery.Common.MediaMethods.GetAlt(Eval("GalleryName").ToString(),"gallery")%>' />
																		...
																		<span class="round4"></span><span class='<%#NGTitleClass(DataBinder.Eval(Container.DataItem, "GalleryName"),DataBinder.Eval(Container.DataItem, "GalleryDescription"))%>'>
																			...
																			<asp:Label ID="lblTGNGDescription" runat="server" CssClass="Description" Text='<%#Server.HtmlDecode(DataBinder.Eval(Container.DataItem, "GalleryDescription").ToString())%>'
