<%@ control language="C#" autoeventwireup="true" inherits="EasyDNN.Modules.EasyDNNGallery.DesktopModules_EasyDNNGallery_Controls_VideoGallery2Control, App_Web_videogallery2-2_leftthumbs.ascx.e652496d" %>
<style type="text/css">
.titleempty
{
	display:none;
																	...
																	<div id="Div1" style="z-index: 0">
																		...
																		<div class="VideoDescription">
																			<asp:Label ID="Label3" CssClass="EDGTitleText" runat="server" 
																				Text='<%# ShowDescription(DataBinder.Eval(Container.DataItem, "Description"))%>' 
																			   ></asp:Label>
																		</div>
																	</div>
																</asp:PlaceHolder>
																	...
																	<div id="embedvideo" style="z-index: 0">
																		...
																		<div class="VideoTitle">
																			<asp:Label ID="lblVGEVMediaTitle" runat="server" Text='<%#ShowTitle(DataBinder.Eval(Container.DataItem, "Title"))%>'
																				CssClass="EDGTitleText"></asp:Label></div>
																		<div class="VideoDescription">
																			<asp:Label ID="lblVGEVMediaDescription" CssClass="EDGTitleText" runat="server" Text='<%# ShowDescription(DataBinder.Eval(Container.DataItem, "Description"))%>'></asp:Label></div>
																	</div>
																	<script type="text/javascript">
																...
																<asp:PlaceHolder ID="phEVVideo" runat="server" 
																	...
																	<div class="VideoTitle">
																		<asp:Label ID="lblVGEVMediaTitle2" runat="server" CssClass="EDGTitleText" 
																			Text='<%#ShowTitle(DataBinder.Eval(Container.DataItem, "Title"))%>' ></asp:Label></div>
																	<div class="VideoDescription">
