<%@ control language="C#" autoeventwireup="true" inherits="EasyDNN.Modules.EasyDNNGallery.DesktopModules_EasyDNNGallery_Controls_SSThumbnails2Control, App_Web_ssthumbnails20_3 - responsive.ascx.b928f30d" %>
															...
															<asp:Repeater ID="repGallerific" runat="server" DataSourceID="odsGetOnlyImages" OnItemCreated="repGallerific_ItemCreated">
																<ItemTemplate>
																	<li><a class="thumb" href='<%#GetThumbPathMain(DataBinder.Eval(Container.DataItem, "GallerificThumb"),DataBinder.Eval(Container.DataItem, "PictureID")) %>'
																		...
																		<span><%#ShowTitle(DataBinder.Eval(Container.DataItem, "Title"),DataBinder.Eval(Container.DataItem, "PictureID"))%></span>
																	</a>
																		<div class="caption">
			...
			<%=jQuery%>(document).ready(function($) {
				...
				$(window).resize(function () {
					$('.slideshow-container').each(function () {
						...
						$container.height($('> #slideshow > .image-wrapper.current', $container).outerHeight(true));
					});
				});
