<%@ control language="C#" autoeventwireup="true" inherits="EasyDNN.Modules.EasyDNNGallery.DesktopModules_EasyDNNGallery_Controls_LightboxNested, App_Web_lightbox3.ascx.c5ff317f" %>
<style type="text/css">
...
<script type="text/javascript">
			...
			function EndRequestHandler(sender, args) 
			{
				<%=jQuery%>(document).ready(function ($) 
				{
					...
					if(sender._postBackSettings.sourceElement.id.indexOf('<%=ModuleId%>') !== -1)
					{
						if(sender._postBackSettings.sourceElement.id.indexOf('ibNestedGallery') !== -1)
						{
							$('a:first', $('#<%=dlTableGallery.ClientID %>')).click();
						}
					}
										...
										<div class="EDGcornertopright">
											<div class="EDGcontent" id="eds">
												...
												<asp:Panel ID="pnlNestedGalleries" runat="server" HorizontalAlign="Center">
													<asp:DataList ID="dlNestedCategory" runat="server" role="presentation"  DataKeyField="GalleryID" OnItemCommand="dlNestedCategory_ItemCommand" CellPadding="0" RepeatDirection="Horizontal" RepeatColumns="4" Font-Bold="False" Font-Italic="False" Font-Overline="False" RepeatLayout="Table"
															...
															<div class="EDGmain">
																<div class="EDGimage">
																	...
																	<a id="A1" href="" runat="server">
																		<asp:ImageButton ID="ibNestedGallery" runat="server" CommandName="OpenNestedGallery" CommandArgument='<%#Eval("GalleryID")%>' ImageUrl='<%#GetGalleryThumbPath(DataBinder.Eval(Container.DataItem, "GalleryID")) %>' ImageAlign="Middle" AlternateText='<%#EasyDNN.Modules.EasyDNNGallery.Common.MediaMethods.GetAlt(Eval("GalleryName").ToString(),"gallery")%>' />
													...
													<asp:GridView ID="gvNestedPaging" runat="server" role="presentation" AllowPaging="True" AutoGenerateColumns="False" BorderStyle="None" BorderWidth="0px" CssClass="pagerbox" HorizontalAlign="Center" DataKeyNames="GalleryID" GridLines="None" OnPageIndexChanging="gvNestedPaging_PageIndexChanging"
												...
												<asp:Panel ID="pnlTGDisplay" runat="server" HorizontalAlign="Center">
													...
													<asp:ObjectDataSource ID="odsTGMedia" runat="server" TypeName="EasyDNN.Modules.EasyDNNGallery.DataAcess" SelectMethod="GetRandomImagesFromGalleryOnlyIdFile" OldValuesParameterFormatString="{0}">
														<SelectParameters>
													...
													<asp:DataList ID="dlTableGallery" runat="server" role="presentation"  CellPadding="0" RepeatDirection="Horizontal" RepeatColumns="4" Font-Bold="False" Font-Italic="False" Font-Overline="False" CssClass='<%#FixedResponsiveClass%>' Font-Strikeout="False" Font-Underline="False"
														...
														<ItemTemplate>
															<asp:PlaceHolder ID="plImage" runat="server" Visible='<%# ToDisplay("Image",DataBinder.Eval(Container.DataItem, "MediaType"))%>'>
																...
																<div style="clear: both; display: block; text-align: center;">
																	<asp:HyperLink ID="hlDownloadImage" runat="server" NavigateUrl='<%#Eval("GetImageDownURL")%>' Visible='<%#Eval("GetDownloadVisible")%>' CssClass="downloadlink"><%=strDownloadImage%></asp:HyperLink></div>
															</asp:PlaceHolder>
													...
													<%=SetupSSValues()%>
													<asp:GridView ID="gvTGPagination" runat="server" role="presentation"  AllowPaging="True" DataKeyNames="PictureID" OnPageIndexChanged="GridView1_PageIndexChanged" OnPreRender="gvTGPagination_PreRender" Width="28px" HorizontalAlign="Center" ShowFooter="True" AutoGenerateColumns="False"
														PageSize="1" ShowHeader="False" BorderWidth="0px" BorderStyle="None" Border="0" GridLines="None" CssClass="pagerbox" EnableViewState="False" EnableModelValidation="True" DataSourceID="odsTGMedia">
														<Columns>
