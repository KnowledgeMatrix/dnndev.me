<%@ control language="C#" autoeventwireup="true" inherits="EasyDNN.Modules.EasyDNNGallery.DesktopModules_EasyDNNGallery_Controls_LightboxControl, App_Web_lightbox2.ascx.c5ff317f" %>
<style type="text/css">
	...
	#<%=ModuleNBR%>EasyDNNGallery .EDGresponsive table.Lightbox2table
	{
		width: 100%;
	}
	#<%=ModuleNBR%>EasyDNNGallery .EDGlightboxNested.EDGresponsive .Lightbox2table td
	{
		width: 47%;
	}
	#<%=ModuleNBR%>EasyDNNGallery .EDGlightbox.EDGresponsive .Lightbox2table td
	{
		width: 47%;
	}
	...
	#<%=ModuleNBR%>EasyDNNGallery .EDGresponsive div.titleimage, #<%=ModuleNBR%>EasyDNNGallery .EDGresponsive div.title, #<%=ModuleNBR%>EasyDNNGallery .EDGresponsive .title span, #<%=ModuleNBR%>EasyDNNGallery .EDGresponsive div.descimage
	{
		width: 100% !important;
		max-width: <%=myappSettings.TGImageWidth%>px;
	}
									...
									<div class="EDGcornertopright">
										...
										<asp:Literal ID="ltedsLightBoxData" enableviewstate="False" runat="server"></asp:Literal>
											...
											<asp:Panel ID="pnlNestedGalleries" runat="server" HorizontalAlign="Center">
														<asp:DataList ID="dlNestedCategory" runat="server" role="presentation"  DataKeyField="GalleryID" OnItemCommand="dlNestedCategory_ItemCommand"
													...
													<ItemTemplate>
														<table cellpadding="0" cellspacing="0" class="Lightbox2table">
															<tr>
																<td valign="top">
																	<div class="EDGmain">
																		<div class="EDGimage">
																			...
																			<a id="A1" href="" runat="server">
																				<asp:ImageButton ID="ibNestedGallery" runat="server" CommandName="OpenNestedGallery"
																					CommandArgument='<%#Eval("GalleryID")%>' ImageUrl='<%#GetGalleryThumbPath(DataBinder.Eval(Container.DataItem, "GalleryID")) %>' ImageAlign="Middle" AlternateText='<%#EasyDNN.Modules.EasyDNNGallery.Common.MediaMethods.GetAlt(Eval("GalleryName").ToString(),"gallery")%>' />
																...
																<td valign="top" style="padding-top: 10px;">
																	<div class="titleimage" style='width: <%=myappSettings.NGThumbWidth%>px;'>
																		<div class='<%#NGTitleClass(DataBinder.Eval(Container.DataItem, "GalleryName"),DataBinder.Eval(Container.DataItem, "GalleryDescription"))%>'>
																			<asp:Label ID="lblTGNGTitle" runat="server" Text='<%#Server.HtmlDecode(DataBinder.Eval(Container.DataItem, "GalleryName").ToString())%>'
																				Visible='<%#NGTitleToDisplay(Eval("GalleryName"))%>'></asp:Label></div>
																	</div>
																	<div class="descimage" style='width: <%=myappSettings.NGThumbWidth%>px;'>
																		<asp:Label ID="lblTGNGDescription" runat="server" CssClass="DescriptionImage" Text='<%#Server.HtmlDecode(DataBinder.Eval(Container.DataItem, "GalleryDescription").ToString())%>'
												...
												<asp:GridView ID="gvNestedPaging" runat="server" role="presentation"  AllowPaging="True" AutoGenerateColumns="False"
													BorderStyle="None" BorderWidth="0px" CssClass="pagerbox" DataKeyNames="GalleryID"
													GridLines="None" OnPageIndexChanging="gvNestedPaging_PageIndexChanging" ShowHeader="False"
													Visible="False" ShowFooter="True" HorizontalAlign="Center">
													<Columns>
											...
											<asp:Panel ID="pnlTGDisplay" runat="server" HorizontalAlign="Center">
												...
												<asp:DataList ID="dlTableGallery" runat="server" CellPadding="0" role="presentation" RepeatDirection="Horizontal"
													...
													SelectedItemStyle-VerticalAlign="Top" AlternatingItemStyle-VerticalAlign="Top"
													FooterStyle-VerticalAlign="Top" HeaderStyle-VerticalAlign="Top" EnableViewState="False">
													<AlternatingItemStyle HorizontalAlign="Center" />
													<EditItemStyle HorizontalAlign="Center" />
													<ItemTemplate>
														<asp:PlaceHolder ID="plImage" runat="server" Visible='<%# ToDisplay("Image",DataBinder.Eval(Container.DataItem, "MediaType"))%>'>
															<table cellpadding="2" cellspacing="2" class="Lightbox2table">
																<tr>
																	<td valign="top">
																		<div class="EDGmain">
																			<div class="EDGimage">
																				<a data-item-index='<%#Eval("MediaItemIndex")%>' data-mediatype="image" href='<%#Eval("LinkOrLightbox")%>' downhref='<%#Eval("GetLighboxImageDownURL")%>'
																					edgpid='<%#Eval("PictureID")%>' edgmid='<%=ModuleId.ToString()%>' target="<%#Eval("TargetWin")%>"
																					title='<%#Eval("GetDescription3")%>' lbnestedurl='<%#Eval("GetLighboxNestedURL")%>'
																					rel='<%#Eval("RelLink")%>'>
																	...
																	<td valign="top" style="padding-top: 10px;">
																		<div class="titleimage" style='width: <%=myappSettings.TGImageWidth%>px;'>
																		...
																		<div style='width: <%=myappSettings.TGImageWidth%>px;' class="descimage">
																		...
																		<div class="ViewDetailsLink">
																			<a href='<%#Eval("LinkOrLightbox")%>' downhref='<%#Eval("GetLighboxImageDownURL")%>'
																				...
																				edgmid='<%=ModuleId.ToString()%>' target="<%#Eval("TargetWin")%>" e='<%#Eval("GetDescription3")%>'
																				rel="<%#RelLink2()%>">
																				<%=OpenLinkText%></a></div>
																	</td>
																</tr>
																	...
																	<td valign="top" style="padding-top: 10px;">
																		...
																		<div style='width: <%=myappSettings.TGImageWidth%>px;' class="descimage">
																			<asp:Label ID="Label5" CssClass="DescriptionImage" runat="server" Text='<%#Eval("ShowDescription")%>'
																				Visible='<%#Eval("DescriptionToDisplay")%>'></asp:Label></div>
																		<div class="ViewDetailsLink">
																			<a href='<%#Eval("Filename") %>' rel="<%#Eval("RelLink")%>" lbnestedurl='<%#Eval("GetLighboxNestedURL")%>'
																				edgpid='<%#Eval("PictureID")%>' edgmid='<%=ModuleId.ToString()%>' target="<%#Eval("TargetWin")%>"
																				e='<%#Eval("GetDescription3")%>' rel="<%#RelLink2()%>">
																				<%=OpenLinkText%></a></div>
																	</td>
																</tr>
															</table>
																	...
																	<td valign="top" style="padding-top: 10px;">
																		...
																		<div style='width: <%=myappSettings.TGImageWidth%>px;' class="descimage">
																			<asp:Label ID="lblTGDescription5" CssClass="DescriptionImage" runat="server" Text='<%#Eval("ShowDescription")%>'
																				Visible='<%#Eval("DescriptionToDisplay")%>'></asp:Label></div>
																		<div class="ViewDetailsLink">
																			<a href='<%=ModulePath.Replace("Controls/Lightbox/","")%>mp3player.swf?flashvars=autoLoad=true&autoPlay=<%=AudioPlayOnLoad%>&volume=1&song1url=<%=HostPath%><%#Eval("Filename")%>&width=560&height=33&salign=middle&swliveconnect=true&allowscriptaccess=always&wmode=transparent'
																				lbnestedurl='<%#Eval("GetLighboxNestedURL")%>' edgpid='<%#Eval("PictureID")%>'
																				edgmid='<%=ModuleId.ToString()%>' target="<%#Eval("TargetWin")%>" e='<%#Eval("GetDescription3")%>'
																				rel="<%#RelLink2()%>">
																				<%=OpenLinkText%></a></div>
												...
												<%=SetupSSValues()%>
												<asp:GridView ID="gvTGPagination" runat="server" role="presentation"  AllowPaging="True" DataKeyNames="PictureID"
													OnPageIndexChanging="gvTGPagination_PageIndexChanging" OnPageIndexChanged="GridView1_PageIndexChanged" OnPreRender="gvTGPagination_PreRender"
														...
														<tr>
															<td>
																<div class='<%=PreloaderClass%>'>
																	<img id='preloader'alt="preloader" src='<%=ModulePath.Replace("Controls/Lightbox/","")%>images/<%=PreloaderImage%>' />
																</div>
															</td>
														</tr>
													</table>
